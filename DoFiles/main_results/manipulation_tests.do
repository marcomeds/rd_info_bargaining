...
rddensity index if inlist(quadrant,2,4), c(0) plot all  graph_opt(graphregion(color(white)) legend(off) xtitle("L2 distance to center")  xline(211, lcolor(black)) note("Conventional p-value :  `:display %5.2f `e(pv_p)''") caption("Robust p-value : `:display %5.2f `e(pv_q)''", size(small))) ///
cirl_opt(color(navy%60)) esll_opt(color(navy) lwidth(medthick)) histl_opt(barw(`=min(3*`e(h_l)',211)/(ceil(max(sqrt(`e(N_l)'),10*log(`e(N_l)')/log(10))))') color(navy%30))  ///
cirr_opt(color(maroon%60)) eslr_opt(color(maroon) lwidth(medthick)) histr_opt(barw(`=3*`e(h_r)'/(ceil(max(sqrt(`e(N_r)'),10*log(`e(N_r)')/log(10))))') color(maroon%30))  
...
rddensity index if inlist(quadrant,1,3), c(0) plot all  graph_opt(graphregion(color(white)) legend(off) xtitle("L2 distance to center")  xline(211, lcolor(black)) note("Conventional p-value :  `:display %5.2f `e(pv_p)''") caption("Robust p-value : `:display %5.2f `e(pv_q)''", size(small))) ///
cirl_opt(color(navy%60)) esll_opt(color(navy) lwidth(medthick)) histl_opt(barw(`=min(3*`e(h_l)',211)/(ceil(max(sqrt(`e(N_l)'),10*log(`e(N_l)')/log(10))))') color(navy%30))  ///
cirr_opt(color(maroon%60)) eslr_opt(color(maroon) lwidth(medthick)) histr_opt(barw(`=3*`e(h_r)'/(ceil(max(sqrt(`e(N_r)'),10*log(`e(N_r)')/log(10))))') color(maroon%30))  
