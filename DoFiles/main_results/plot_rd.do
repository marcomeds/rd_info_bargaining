...
graph export "$directory/Figuras/rdplot_`var'_tenure_`t'.pdf", replace
...
graph export "$directory/Figuras/rdplot_`var'_dw_`t'.pdf", replace
...
graph export "$directory/Figuras/rdplot_`var'_2_4_`t'.pdf", replace
